...
export type TextVariant = 
 ...
 ${({ variant, fontSize, letterSpacing, lineHeight, theme}) => {
    ...
    if (variant && variants[variant]) {
        const styles = []
        !fontSize &&
            styles.push(toPropValue('fontSize', variants[variant].fontSize, theme))
        !letterSpacing &&
            styles.push(toPropValue('letterSpacing',variants[variant].letterSpacing, theme),
         )
        !lineHeight &&
            styles.push(toPropValue('lineHeight',variants[variant].lineHeight, theme),
         )
        return styles.join('\n')
    }
 }}
